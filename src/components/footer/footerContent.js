...
<div className="footer">
    ...
    <span> <FontAwesomeIcon icon = {faPhone} />  &nbsp; 123 45 453</span>
    <span> <FontAwesomeIcon icon={faEnvelope} />  &nbsp; nlya@gmail.com</span>
      </div>
      ...
      <div className="footer-section contact-form">
       ...
       <input  type='email' name ='email' className= 'text-input contact-input' placeholder='Enter your email here'/> 
       
       <textarea className='tex-input contact-input' placeholder='Enter message here!'/>
      <br />
